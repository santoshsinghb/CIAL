	...
	public void to_verify_user_is_able_to_create_new_user_in_gha_user_master_screen() throws InterruptedException {
		...
		//  Thread.sleep(3000);
		 ...
		 //  driver.close();
		   ...
		   Thread.sleep(1000);
			  ce.celibiNewUsernameInput.sendKeys("ROCKS");
			  Thread.sleep(1000);
			  ce.celibiNewName.click();
			  Thread.sleep(1000);
			  ce.celibiNewName.sendKeys("abhi");
			  Thread.sleep(1000);
			  ce.celibiNewLastName.click();
			  Thread.sleep(1000);
			  ce.celibiNewLastName.sendKeys("shek");
			  Thread.sleep(3000);
			  ce.celibiNewEmailId.click();
			  ce.celibiNewEmailId.sendKeys("abcKALE@gmail.com");
			  Thread.sleep(1000);
			  ce.celibiNewLocation.sendKeys("AAA");
			 ...
			 //  driver.close();
			   ...
			   ce.celibinewPassword.sendKeys("abhi@123");
			   Thread.sleep(2000);
			   ce.celibiconfirmNewPassword.clear();
			   ce.celibiconfirmNewPassword.sendKeys("abhi@123");
			   Thread.sleep(2000);
			   ...
			   Thread.sleep(5000);
			   ce.celibiUserNameInput.click();
				  ce.celibiUserNameInput.sendKeys("ROCKS");
				  Thread.sleep(3000);
				  ce.celibiPasswordInput.click();
				  ce.celibiPasswordInput.sendKeys("abhi@123");
				  Thread.sleep(3000);
				  ce.celibiLoginBtn.click();
				  Thread.sleep(5000);
	}
...
//--------------------#14
	...
	public void to_verify_user_is_able_to_create_new_airline_into_airline_screen_in_masters_of_gha_application() throws InterruptedException {
		...
		/*  ce.celibiNewIconBtn.click();
		  Thread.sleep(3000);
		  ce.celibiCarrierCode.sendKeys("0ABH");
		  Thread.sleep(2000);
		  ce.celibiShortCode.sendKeys("ABH");
		  Thread.sleep(2000);
		  ce.celibiAirlineName.sendKeys("ABHIFLY");
		  Thread.sleep(2000);
		  ce.celibiWOCcode.sendKeys(" ");
		  Thread.sleep(2000);
		  ce.celibiprefixDetailsBtn.click();
		  Thread.sleep(2000);
		  ce.celibiPrefixField.sendKeys("239");
		  Thread.sleep(2000);
	...
	/*	  ce.celibiNewIconBtn.click();
		  ...
		  ce.celibischeduleairlineNameFiled.sendKeys("GOA");
		  Thread.sleep(2000);
		  ce.celibischeduleairlineFromdate.sendKeys("12/07/2023");
		  Thread.sleep(2000);
	...
	public void to_verify_user_is_able_to_navigate_to_airport_city_in_gha_masters() throws InterruptedException {
		ce.celibiUserNameInput.click();
		  ...
		  ce.celibiNewIconBtn.click();
		  Thread.sleep(2000);
		  ce.celibiAirportCityAirportCode.sendKeys("MAX");
		  Thread.sleep(3000);
		  
		  ce.celibiAirportCityNameAirport.sendKeys("max_INTERNATIONAL");
		  Thread.sleep(3000);
		  driver.switchTo().alert().accept();
		   Thread.sleep(3000);
		  ce.celibiAirportCityCode.sendKeys("max");
		  Thread.sleep(2000);
		  ce.celibiAirportCityName.sendKeys("maxi");
		  Thread.sleep(2000);
		  ce.celibiAirportCityStateCode.sendKeys("04");
		  Thread.sleep(2000);
		  ce.celibiAirportCityCountryCode.sendKeys("IN");
		  Thread.sleep(2000);
		  ce.celibiAirportCitySitaAddress.sendKeys("ABHISHE");
		  Thread.sleep(2000);
		  ce.celibiAirportCityCustPermissionNum.sendKeys("128754");
		  Thread.sleep(2000);
		  ce.celibiFLOPPYSAVEbtn.click();
		  Thread.sleep(20000);
	}
	...
	/*	  ce.celibiNewIconBtn.click();
		  Thread.sleep(2000);
		  ce.celibiMasterMoreCountryMasterCountryCode.sendKeys("GC");
		  Thread.sleep(2000);
	...
	public void to_verify_user_is_able_to_navigate_to_customer_master_in_gha_masters() throws InterruptedException {
		ce.celibiUserNameInput.click();
		  ...
		  ce.celibiNewIconBtn.click();
		  Thread.sleep(5000);
		  ce.celibiMasterMoreCustomerMasterShortCode.sendKeys("AFS");
		  Thread.sleep(2000);
		  ce.celibiMasterMoreCustomerMasterCustomername.sendKeys("ALL FLY");
		  Thread.sleep(2000);
		  ce.celibiMasterMoreCustomerMasterSreetAddress.sendKeys("PUNE");
		  Thread.sleep(2000);
		  ce.celibiMasterMoreCustomerMasterplace.sendKeys("PUNE");
		  Thread.sleep(2000);
	...
	public void to_verify_user_is_able_to_update_customer_as_active_from_gha_customer_master_screen() throws InterruptedException {
		ce.celibiUserNameInput.click();
		  ...
		  Thread.sleep(2000);
		  ce.celibiMasterMoreCustomerMasterCustomername.sendKeys("ALL NEW FLY");
		  Thread.sleep(2000);
		  ce.celibiMasterMoreCustomerMasterSreetAddress.sendKeys("NEW PUNE");
		  Thread.sleep(2000);
		  ce.celibiMasterMoreCustomerMasterplace.sendKeys("NEW PUNE");
		  Thread.sleep(2000);
		  ce.celibiMasterMoreCustomerStatecode.sendKeys("");
		  Thread.sleep(2000);
		  ce.celibiMasterMoreCustomerstate.sendKeys("MAHARASHTRA");
	...
	public void to_verify_user_is_able_to_add_tax_details_to_selected_customer_from_customer_master_screen() throws InterruptedException {
		ce.celibiUserNameInput.click();
		  ...
		  String parent=driver.getWindowHandle();
		   ...
		   Thread.sleep(1000);
		   driver.findElement(By.name("ctl00$cp$txtTaxIdNo")).sendKeys("97654245");
		   Thread.sleep(2000);
	...
	public void to_verify_user_is_able_to_navigate_to_currency_master_in_gha_masters() throws InterruptedException {
		ce.celibiUserNameInput.click();
		  ...
		  ce.celibiNewIconBtn.click();
		  Thread.sleep(3000);
		  driver.findElement(By.name("ctl00$cp$tc$tp2$ctl00$uxCurrencyCode")).sendKeys("RUP");
		  Thread.sleep(1000);
		  driver.findElement(By.name("ctl00$cp$tc$tp2$ctl00$uxDecimalPlaces")).sendKeys("2");
		  Thread.sleep(1000);
		  driver.findElement(By.name("ctl00$cp$tc$tp2$ctl00$uxCurrencyName")).sendKeys("Indian rupee");
		  Thread.sleep(1000);
	...
	public void to_verify_user_is_able_to_add_new_commodity_in_commodity_master_in_gha_application() throws InterruptedException {
		ce.celibiUserNameInput.click();
		  ...
		  Thread.sleep(1000);
		  driver.findElement(By.name("ctl00$cp$tc$tp2$ctl00$uxtxtDensityKg")).sendKeys("1003");
		  Thread.sleep(1000);
		  driver.findElement(By.name("ctl00$cp$tc$tp2$ctl00$uxtxtDensityGroup")).sendKeys("1001");
		  Thread.sleep(1000);
	...
	public void to_verify_user_is_able_to_schedule_flight_in_master_screen() throws InterruptedException {
		ce.celibiUserNameInput.click();
		 ...
		 //  driver.close();
		   ...
		   Thread.sleep(2000);
		   driver.findElement(By.name("ctl00$cp$tc$tp2$ctl00$uxFlightNo")).sendKeys("8A7209");
		   Thread.sleep(2000);
		   driver.findElement(By.name("ctl00$cp$tc$tp2$ctl00$uxAircraftType$FMSReferenceDataSelected")).sendKeys("319");
		   Thread.sleep(2000);
		   driver.findElement(By.name("ctl00$cp$tc$tp2$ctl00$uxFromDate$txtDateField")).sendKeys("05/07/2023");
		   Thread.sleep(2000);
		   driver.findElement(By.name("ctl00$cp$tc$tp2$ctl00$uxToDate$txtDateField")).sendKeys("31/07/2023");
		   Thread.sleep(2000);
		   ce.celibiMasterMoreflightRoutingDetails.click();
			  Thread.sleep(2000);
	...
	public void to_verify_user_is_able_to_navigate_to_airline_uld_mapping_screen_in_gha_application() throws InterruptedException {
		ce.celibiUserNameInput.click();
		  ...
		  driver.switchTo().frame(0);
		   Thread.sleep(2000);
		   driver.findElement(By.name("ctl00$cp$uxULDOwner$FMSAirlineSelected")).sendKeys("3A");
		   Thread.sleep(2000);
			  driver.findElement(By.name("ctl00$cp$uxULDType$FMSReferenceDataSelected")).sendKeys("JET");
			  Thread.sleep(2000);
			  driver.findElement(By.name("ctl00$cp$uxtxtTareWt$Number")).sendKeys("239");
			  Thread.sleep(2000);
			  driver.findElement(By.name("ctl00$cp$uxtxtMaxAllowed$Number")).sendKeys("2039");
			  Thread.sleep(2000);
			  ce.celibiFLOPPYSAVEbtn.click();
			  Thread.sleep(2000);
	...
	public void to_verify_user_is_able_to_navigate_to_screen_er_master_screen_in_gha_application() throws InterruptedException {
		ce.celibiUserNameInput.click();
		  ...
		  Thread.sleep(2000);
		  driver.findElement(By.name("ctl00$cp$uxGrdM$ctl02$uxEdtExp$txtDateField")).sendKeys("31/07/2023");
		  Thread.sleep(2000);
